...
def returnDefault(ftp):
    try:
        ...
        dirList = []
        print '[-] Could list directory contents'
        print '[-] Skipping To Next Target'
        return
    retList =[]
    for fileName in dirList:
        fn = fileName.lower()
        if '.php' or '.htm' or '.asp' in fn:
...
def main():
    parser = optparse.OptionParser('ussage%prog ' + '-H <target host[s]> -r <redirect page>'+ '[-f <userpass file>]')
    ...
    parser.add_option('-r',dest='redirect',type='string',help='specify target redirection page')
